...
<head>
    ...
    <title>Sistem Informasi Pelayanan Registrasi Mahasiswa Terintegrasi</title>
        ...
        <div class="container mx-auto px-6 py-3">
            <div class="flex items-center justify-between">
                <div class="flex items-center">
                    <img src="https://placehold.co/50x50" alt="Logo Universitas dengan lambang akademik dalam warna putih" class="mr-3" />
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div class="bg-white p-6 rounded-xl shadow-md">
                    <div class="flex items-center mb-4">
                        <img src="https://placehold.co/60x60" alt="Foto mahasiswi berpakaian rapi dengan latar belakang kampus" class="rounded-full h-12 w-12 object-cover mr-3" />
                        <div>
                ...
                <div class="bg-white p-6 rounded-xl shadow-md">
                    <div class="flex items-center mb-4">
                        <img src="https://placehold.co/60x60" alt="Foto mahasiswa berkacamata dengan latar belakang perpustakaan" class="rounded-full h-12 w-12 object-cover mr-3" />
                        <div>
                ...
                <div class="bg-white p-6 rounded-xl shadow-md">
                    <div class="flex items-center mb-4">
                        <img src="https://placehold.co/60x60" alt="Foto staff administrasi kampus dengan identitas nama di dada" class="rounded-full h-12 w-12 object-cover mr-3" />
                        <div>
    ...
    <footer id="kontak" class="bg-gray-800 text-white py-12">
        <div class="container mx-auto px-6">
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                ...
                <div>
                    ...
                    <p class="text-gray-400">
                        Sistem Informasi Pelayanan Registrasi Mahasiswa Terintegrasi merupakan platform digital untuk mempermudah proses registrasi mahasiswa baru dan lama.
                    </p>
                </div>
            ...
            <div class="border-t border-gray-700 mt-10 pt-6 text-center text-gray-400">
                <p>&copy; 2023 Sistem Informasi Pelayanan Registrasi Mahasiswa Terintegrasi. Seluruh hak cipta dilindungi.</p>
            </div>
        </div>
    </footer>
